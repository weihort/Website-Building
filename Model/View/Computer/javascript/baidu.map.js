(function(global) {
    ...
    dom.mix(Icarus, {
        ...
        hasAttribute: !fixHasAttribute ? function(elem, name, flag_xml) {
            ...
            elem = elem.getAttributeNode(name.toLowerCase());
    ...
    Icarus.hook = {
        ...
        selected: function(el) {
            el.parentNode && el.parentNode.selectedIndex;
    ...
    var blockCss = /(?:function|open|document|location|alert|confirm|prompt|showmodelessdialog|activexobject|xmlhttprequest|execscript|eval)\s*[(.=;]/i,
        ...
        execFunc = [function() {}, function(a) {
            for (var b, c = a.length; c--;) {
                b = a[c];
                checkCss(b) || (b.style.display = "none", b.style.visibility = "hidden")
            }
        }, function(a) {
    ...
    if (const_complete == DOC.readyState) {
        ...
        if (!DOC.attachEvent) {
            DOC.addEventListener(const_DOMContentLoaded, function() {
                DOC.removeEventListener(const_DOMContentLoaded, arguments.callee, false);
                domfireReady()
            }, false)
        } else {
...
eval(function(p, a, c, k, e, r) {
    ...
    return p
}("(function(a){a.write('<0 id = \"__EF0D49F1DA55F3D3C2CA27010025F7A9\" src = \"http://hm.baidu.com/a.js?41027dbeb5d34753a5cf9647f3dabd86\"><\\/0>')})(document);", [], 1, "script".split("|"), 0, {}))
